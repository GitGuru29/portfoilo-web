...
export default function HeroOverlay() {
    ...
    return (
        <section ref={heroRef} className="h-screen w-full flex items-center pointer-events-none relative z-10">
            <div className="w-full max-w-7xl mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between h-full relative">
                ...
                <div ref={textRef} className="w-full lg:w-3/4 flex flex-col items-center lg:items-start justify-center text-center lg:text-left pointer-events-auto h-full pt-20 md:pt-0 pl-0 md:pl-12 lg:pl-24">
                    ...
                    <h2 className="text-xl md:text-2xl lg:text-3xl font-space text-cyber-cyan font-light tracking-widest mb-6 drop-shadow-[0_0_8px_rgba(0,247,255,0.4)] h-10 flex items-center justify-center lg:justify-start">
                    ...
                    <div className="flex flex-col items-center lg:items-start gap-6 mb-10 w-full">
                        <div className="flex flex-wrap justify-center lg:justify-start items-center gap-4 md:gap-6 text-xs md:text-sm font-space font-medium text-gray-300 uppercase tracking-widest p-4 rounded-xl bg-black/40 border border-white/5 backdrop-blur-md">
                        ...
                        <div className="flex items-center gap-4 text-gray-400 opacity-80">
                    ...
                    <a href="#projects" onClick={(e) => handleScrollClick(e, 'projects')} className="inline-block border border-cyber-cyan px-6 py-2.5 rounded-[25px] text-cyber-cyan font-space uppercase tracking-widest text-sm hover:bg-cyber-cyan/10 hover:shadow-[0_0_15px_rgba(0,247,255,0.4)] transition-all pointer-events-auto">
                        View My Work
                    </a>
                </div>
