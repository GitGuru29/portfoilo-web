...
import { Clock, Folder, Home, Terminal } from 'lucide-react';
...
export default function TerminalSection() {
    ...
    const [history, setHistory] = useState(hasBooted ? [
        { text: "Session restored. Type 'help' for commands.", type: 'sys' }
    ] : [
                ...
                >
                    ...
                    >
                        ...
                        <div className="w-full h-10 bg-[#16161e] border-b border-white/5 flex items-center px-4 justify-between select-none">
                            ...
                            <div className="text-[#a9b1d6] text-xs font-bold tracking-widest opacity-50 flex items-center gap-2">
