...
export default function Contact() {
    ...
    return (
        <>
            ...
            <footer className="w-full border-t border-white/5 bg-[#030303] py-8 px-6 relative z-20">
                <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 items-center gap-8 md:gap-4">
                    ...
                    <div className="flex items-center justify-center md:justify-start">
                        <img
                            src="/sn-logo.png"
                            alt="SN Logo"
                            className="w-12 h-12 object-contain drop-shadow-[0_0_8px_rgba(0,243,255,0.4)] hover:drop-shadow-[0_0_14px_rgba(0,243,255,0.7)] hover:scale-105 transition-all duration-300"
                        />
                    </div>

                    {/* Center: Brand + Status */}
                    <div className="flex flex-col items-center text-center">
                        <span className="text-lg md:text-xl font-orbitron font-black tracking-[0.2em] text-transparent bg-clip-text bg-gradient-to-r from-cyber-cyan to-cyber-violet">
                            SILUNA NUSAL
                        </span>
                        <div className="flex items-center gap-2 text-[10px] md:text-xs font-space tracking-widest text-cyber-cyan mt-1">
                    ...
                    <div className="flex items-center justify-center md:justify-end gap-6">
                        <a href="https://github.com/GitGuru29" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white hover:drop-shadow-[0_0_8px_rgba(255,255,255,0.5)] hover:-translate-y-1 transition-all duration-300">
                        ...
                        <a href="#" className="text-gray-400 hover:text-[#0077B5] hover:-translate-y-1 transition-all duration-300">
                            <span className="sr-only">LinkedIn</span>
                            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                                <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd" />
                            </svg>
                        </a>
                        <a href="mailto:sdangalla66@gmail.com" className="text-gray-400 hover:text-red-500 hover:-translate-y-1 transition-all duration-300">
