...
const WhatsAppChat = () => {
    ...
    return (
        <motion.div 
            className="fixed bottom-24 right-6 md:right-8 z-[89] pointer-events-auto"
        ...
        >
            ...
            >
                <svg 
                    viewBox="0 0 24 24" 
                    fill="currentColor" 
                    className="w-4.5 h-4.5 text-slate-400 group-hover:text-[#25D366] transition-colors duration-300"
